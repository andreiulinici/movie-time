...
export class MovieService{
    ...
    getPopular(){
     ...
     getInTheaters(){
        return this._jsonp.get('https://api.themoviedb.org/3/discover/movie?callback=JSONP_CALLBACK&primary_release_date.gte=2017-06-20&primary_release_date.lte=2017-08-02&sort_by=popularity.desc&api_key=2931998c3a80d7806199320f76d65298')
            .map(res => res.json());
    }
